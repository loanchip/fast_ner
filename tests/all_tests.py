...
def test_2(data, csv_data):
    ...
    expected_output = ("{'movies': [(['travel', 'mates', '2'], 5, 8), "
                        "(['marc', 'maron', 'too', 'real'], 9, 13)], "
                        "'fuzzy_matches': {'movies': [('Marc Maron: Too Real', 0.569703524874188), "
                        "('Travel Mates 2', 0.43260186577568377)]}}")
...
def test_3(data):
    ...
    expected_output = ("{'movies': [(['naruto'], 3, 4), (['naruto'], 5, 6), "
